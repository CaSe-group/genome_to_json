...
//            def preceding_tool_active = false
//
//            tool_list.eachWithIndex { element, index ->
//                if ( !params."${element}_off" ) {
//                    tool_report = Channel.fromPath(workflow.projectDir + "/submodule/rmarkdown_reports/rmarkdown_reports/templates/${element}.Rmd", checkIfExists: true)
//                    "${element}"_report("${element}"_report_ch.combine(tool_report))
//                    //tool_list.add(${it}_report.out)
//                    if ( !preceding_tool_active ) {
//                        samplereportinput = "${element}"_report.out //if its the first element of the list open a new channel containing the element
//                        preceding_tool_active = True
//                    }
//                    else {
//                        samplereportinput = samplereportinput.mix("${element}"_report.out) //if its not the first list-element add it to the created channel
//                    }
//                }
//            }
